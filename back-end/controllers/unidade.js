...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Unidade.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Unidade.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Unidade.findByIdAndDelete(id)
